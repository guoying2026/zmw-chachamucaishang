<template>
    <div class="like_div" v-if="userInfoStore.getUserId()*1 > 0">
      <div class="comment_item_4_s s_1" @click="toggleCurrentUserReaction('liked')">
        <!-- 点赞图标 -->
        <svg class="icon grey-color" viewBox="0 0 1024 1024" width="200" height="200" v-show="displayData && displayData.currentUserReaction !== 'liked'">
        ...
        <text class="margin-10-left grey-color">{{ displayData && displayData.likes }}</text>
      </div>
      <div class="comment_item_4_s s_2" @click="toggleCurrentUserReaction('disliked')">
        <!-- 倒赞图标 -->
        <svg class="icon grey-color" viewBox="0 0 1024 1024" width="200" height="200" v-show="displayData && displayData.currentUserReaction !== 'disliked'">
        ...
        <text class="margin-10-left grey-color">{{displayData && displayData.dislikes }}</text>
      </div>
    </div>
    <LoginPopup v-else>
      <template #open>
