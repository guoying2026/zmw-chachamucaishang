      ...
      <div class="comment_item_2">
        ...
        <div class="comment_item_3">
          ...
          <div class="comment_item_4">
            <LikeSwitch :index="index" :store="props.store"></LikeSwitch>
              ...
              <div class="reply_item_4">
                <div class="comment_item_4_s s_1">
                  <svg class="icon grey-color" viewBox="0 0 1024 1024" width="200" height="200">
                    <path d="M341.196926 1023.989977H85.299231a84.019743 84.019743 0 0 1-85.299231-82.313758V466.5595A84.019743 84.019743 0 0 1 85.299231 384.245742h255.897695zM85.299231 938.690746h170.598463V469.544973H85.299231z" fill="#ffffff" p-id="9342"></path>
