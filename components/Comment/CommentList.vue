<template>
  <div class="comment">
    <div class="comment_item" v-for="comment in store.comments">
        ...
        <div class="comment_item_3">
          ...
          <div class="comment_item_4">
            <div class="comment_item_4_s s_1">
              ...
              <text class="margin-10-left grey-color">{{comment.likes}}</text>
            </div>
            <div class="comment_item_4_s s_2">
              ...
              <text class="margin-10-left grey-color">{{comment.dislikes}}</text>
            </div>
